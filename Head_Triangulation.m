...
% trisurf( t(:,2:4) , data(:,1) , data(:,2),data(:,3) , 'facecolor' , [0.8,0.0,0.0]   , 'facealpha' , 0,5) ;  %plot della superficie trattata
% trisurf( t(:,[1 2 4]) , data(:,1) , data(:,2),data(:,3) , 'facecolor' , [0.0,0.8,0.0]  , 'facealpha' , 0,5 ) ;  %plot della superficie trattata
% trisurf( t(:,[1 3 4]) , data(:,1) , data(:,2),data(:,3) , 'facecolor' , [0.0,0.0,0.8]  , 'facealpha' , 0,5 ) ;  %plot della superficie trattata
axis equal ;
axis vis3d ;
daspect([1 1 1]) ;
axis on;
